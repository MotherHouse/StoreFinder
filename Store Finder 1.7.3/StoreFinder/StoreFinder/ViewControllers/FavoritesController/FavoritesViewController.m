...
-(void) getFavorites {
    ...
    if(instance.myLocation != nil && RANK_STORES_ACCORDING_TO_NEARBY) {
        ...
        NSArray *sortedArray = [tempArray sortedArrayUsingComparator: ^(Store* obj1, Store* obj2) {
        ...
        listViewMain.arrayData = [NSMutableArray arrayWithArray:tempArray];
    }
}
