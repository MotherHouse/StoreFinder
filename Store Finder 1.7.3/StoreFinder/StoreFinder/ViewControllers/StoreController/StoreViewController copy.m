...
@interface StoreViewController () <MGListViewDelegate, LocationDelegate> {
...
- (void)viewDidLoad {
    ...
    if(appDelegate.myLocation == nil) {
        ...
        [appDelegate findMyCurrentLocation];
    }
    else {
...
-(void)sortByDistance {
    ...
    if(myLocation != nil) {
        ...
        for(Store* store in listViewMain.arrayData) {
            ...
            double distance = [myLocation distanceFromLocation:location] / 1000;
