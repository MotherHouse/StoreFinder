...
//    if([self getFilterDistance] == 0 ) {
//        [self setFilterDistance:DEFAULT_FILTER_DISTANCE_IN_KM];
//    }
    
    if([self getFilterDistanceMax] == 0 ) {
        [self setFilterDistanceMax:MAX_RADIUS_STORE_VALUE_IN_KM];
    }
...
-(float)getFilterDistance {
    return [[[NSUserDefaults standardUserDefaults]objectForKey:@"FILTER_DISTANCE"] floatValue];
}

-(void)setFilterDistance:(float)distance {
    [[NSUserDefaults standardUserDefaults]setObject:[NSString stringWithFormat:@"%f", distance] forKey:@"FILTER_DISTANCE"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}

-(float)getFilterDistanceMax {
    return [[[NSUserDefaults standardUserDefaults]objectForKey:@"FILTER_DISTANCE_MAX"] floatValue];
}

-(void)setFilterDistanceMax:(float)distance {
    [[NSUserDefaults standardUserDefaults]setObject:[NSString stringWithFormat:@"%f", distance] forKey:@"FILTER_DISTANCE_MAX"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
